...
// bJson = eval("(" + args[2] + ")");
// console.log(bJson)
// console.log(eval(args[2]))
// console.log(eval(args[0])(args[1], bJson))
// console.log(args[1], {city: args[2], month: args[3]})
function main(){
    if (func_name=="getParam"){
            console.log(getParam(args[1],{city: args[2], month: args[3]}))
    }else if (func_name == 'decodeData'){
            console.log(decodeData(args[1]))
    }
}
main()